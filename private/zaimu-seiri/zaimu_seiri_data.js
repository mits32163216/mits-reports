...
// 月別の実際に出ていった額（ランニングコスト）。Before総額 945,213 と同じ定義を各月に適用。
// total   = 全カード確定額(JPY+USD@148円/USD) + PayPay直接引落(家賃+電気+ATM現金引出) − 単発（月別実額）− 集計の直し（400/月×8=3,200）
// borrow  = その月に実際に返済した額（楽天引落確定額 + Amex JP 42008 リボ元本+手数料+分割新規 + Amex US 44000 年会費・手数料・利息）
// running = total − borrow
// list/outside は「月別実額」で切り分けられないため列を省略（コーディネーター指示 option 4）
// 単発の月別内訳（Amex US 44000 仕事の外注 + Chase Hyatt 1288 全額(Hyatt Schematic) + BOA VISA 4452 仕事の外注）:
//   2026-01: 22,082 ／ 2026-02: 1,555,230 ／ 2026-03: 33,399 ／ 2026-04: 2,655 ／ 2026-05: 68,013 ／ 2026-06: 0 ／ 2026-07: 11,692
//   単発 7ヶ月合計 1,693,071 (目標 240,277×8=1,922,216 で差 -229,145)。差の理由：アドネス 102,240円（8mo・44000には$79=11,692のみ発見）と BOA→Wise 送金差分 25,699円 は明細で特定できず未計上。
// 手順（9月締め後）：card_shiharai_kanrihyo_2026.csv に9月分請求確定額を反映 → PayPay 14310 の9月分 J仕訳を追記 → 本配列末尾に {month:"2026-09", ...} を1行追加。2026-08 は未締めのため未収載・9月確定後に追記予定。
var MONTHLY_ACTUAL = [
  { month:"2026-01", total:1458393, borrow:195584, running:1262809 },
  { month:"2026-02", total: 211970, borrow:120820, running:  91150 },
  { month:"2026-03", total:1365758, borrow:137706, running:1228052 },
  { month:"2026-04", total: 947089, borrow:146489, running: 800600 },
  { month:"2026-05", total:1040617, borrow:145694, running: 894923 },
  { month:"2026-06", total:1305664, borrow:130769, running:1174895 },
  { month:"2026-07", total: 997500, borrow:118943, running: 878557 }
