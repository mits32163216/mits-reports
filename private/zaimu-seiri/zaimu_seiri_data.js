...
{ id:"k2-19", name:"Netflix", amount:2356, card:"Amex US 72006", memo:"【Mits様 2026-09-18 サブスク整理でdone】\n契約は1本（dai@3216.fun・Amex US 72006・毎月末前後に課金）。加盟店名の3表記（NETFLIX -MINATO-KU／NETFLIX.COM TOKYO／NETFLIX.COM 708340 LOS GATOS）は同じ契約。2026-09-18 検証。", notion_url:"https://app.notion.com/3b100782d90a81b484bee3cdbce97691", url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:"2026-08-31", next_due:"2026-09-30予定", status:"done", status_date:"2026-09-18" },
      ...
      { id:"k2-30", name:"GOOGLE STORE", amount:3611, card:"BOA 3245", memo:"2026-09-20 解約完了（Mits様）", notion_url:"https://app.notion.com/3bf00782d90a81bbb072f7cc74214b96", url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:"2026-09-08", next_due:"2026-10-08予定", status:"done", status_date:"2026-09-20" },
      ...
      { id:"k2-33", name:"SCORESENSE", amount:5268, card:"Amex US 44000", memo:"2026-09-20 解約完了（Mits様）\n【Mits様メモ 2026-09-18】Call our Customer Care department at 1-888-550-2159 or chat with a live agent. We are here to assist you every day of the week:\n\nMonday - Friday, 8AM to 8PM CT\nSaturday, 8AM to 5PM CT\nSunday, Noon to 6PM CT", notion_url:"https://app.notion.com/3b100782d90a811296e9e96beec4d7e7", url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:"2026-08-24", next_due:"2026-09-24予定", status:"done", status_date:"2026-09-20" },
      { id:"k2-34", name:"PRIORITY PASS", amount:2467, card:"Amex JP ANA", memo:"2026-09-20 解約完了（Mits様）\n【Mits様メモ 2026-09-18】営業時間に電話\n1〜7月の請求4回のうち 1/19 5,733 は事業主貸（私用）のため除外。残り3回 17,269 ÷ 7ヶ月＝2,467（2026-09-19 Mits様確認）", notion_url:"https://app.notion.com/3c200782d90a813f8498fb083eeccfd3", url:null, cycle:null, annual_amount:null, annual_jpy:null, last_paid:"2026-06-08", next_due:"要調査", status:"done", status_date:"2026-09-20" },
...
{ id:"k2-42", name:"Skool", amount:15751, card:"", memo:"【Mits様 2026-09-18 サブスク整理でdone】\n2026-09-18 完了。解約方法：コミュニティ設定 → Billing から解約（THE INNOVATION・今の請求期間の終わりでアーカイブ・参加/投稿/チャット不可・支払い受け取り停止・独自URL解放）。", notion_url:"https://app.notion.com/3c200782d90a8199ba0ccac9379e46d0", url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:"2026-08-18", next_due:"2026-09-18予定", status:"done", status_date:"2026-09-18" },
      ...
      { id:"k2-47", name:"HEYGEN", amount:4125, card:"Amex US 44000", memo:"【2026-09-19 解約済み：Amex US 44000 で毎月29日 $46.90（2025-11-29〜2026-03-29）→ 2026-04-25 $10.40・04-29 $44.00 が最後。5/1〜9/9 の明細と MF の仕訳に決済なし】【サブスク外の判定から移動・2026-09-19】BS-keiri の照合で一覧Aへ", notion_url:null, url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:"2026-04-29", next_due:"解約済み", status:"done", status_date:"2026-09-19" },
      ...
      { id:"k2-65", name:"CATCH THE WEB", amount:2217, card:"年払い・Amex US 44000", memo:"【サブスク外の判定から移動・2026-09-20 Mits様「サブスク外ではない　サブスク整理に」「CATCH THE WEB　は年払い」】決済 2026-08-20 $179.73（26,600円 @148）。月割り＝26,600÷12＝2,217。", notion_url:null, url:null, cycle:"annual", annual_amount:"$179.73（26,600円）", annual_jpy:26600, last_paid:"2026-08-20", next_due:"2027-08-20予定", status:null, status_date:null },
      { id:"k2-66", name:"Dify Professional", amount:9118, card:"Amex US 44000", memo:"【サブスク外の判定から移動・2026-09-20 Mits様「サブスク外ではない　サブスク整理に」】初回 2026-08-07 $61.61（9,118円 @148・明細名 DIFY PROFESSIONAL PLWILMINGTON）。月払いとして数えている", notion_url:null, url:null, cycle:"monthly", status:null, status_date:null },
      { id:"k2-67", name:"Windy（Google Play）", amount:308, card:"年払い・Amex US 44000", memo:"【サブスク外の判定から移動・2026-09-20 Mits様「GOOGLE Windy　サブスク　年払い」】決済 2026-08-31 3,699円（@148）。月割り＝3,699÷12＝308。", notion_url:null, url:null, cycle:"annual", annual_amount:"3,699円", annual_jpy:3699, last_paid:"2026-08-31", next_due:"2027-08-31予定", status:null, status_date:null },
      { id:"k2-68", name:"TIER5（5月から VAUGHN LABS 名義・同じ電話番号）", amount:1480, card:"Amex US 81007", memo:"【サブスク外の判定から移動・2026-09-20 Mits様「TIER5 LLC BEAUMOUNT TX が家族カードにある　おかしい　mits　サブスク　完了」】Mits様本人の利用。毎月28日 $10.00（1,480円 @148）：2026-01-28〜04-28 TIER5 LLC ×4、05-28 VAUGHN LABS ×1。6月以降の請求なし。解約完了。", notion_url:null, url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:"2026-05-28", next_due:"解約済み", status:"done", status_date:"2026-09-20" },
      { id:"k2-50", name:"DOCPRO オーソモレキュラー", amount:8427, card:"年払い・Amex US Hilton 72006", memo:"【2026-09-19 Mits様「年払い」】決済は 2026-07-14 $679.39（101,128円・MF #486 接待交際費）の1回。月割り＝101,128÷12＝8,427。1〜7月の月平均で数えていた 14,363 との差 5,936 は一覧Aの「年払いを実額に直した差」に入れた。【サブスク外の判定から移動・2026-09-19】Mits様判断でサブスク側へ（旧：2段目の足し分に入っていた）", notion_url:null, url:null, cycle:"annual", annual_amount:"$679.39（101,128円）", annual_jpy:101128, last_paid:"2026-07-14", next_due:"2027-07-14予定", status:null, status_date:null },
      { id:"k2-64", name:"GRAMMARLY", amount:1987, card:"年払い・Amex JP 42008", memo:"【2026-09-19 Mits様「サブスク年額」】決済は 2026-08-29 $144.00（23,842円・レート 165.569・Amex JP 42008 の 8/21〜の利用）。月割り＝23,842÷12＝1,987。1〜7月には決済なし。", notion_url:null, url:null, cycle:"annual", annual_amount:"$144.00（23,842円）", annual_jpy:23842, last_paid:"2026-08-29", next_due:"2027-08-29予定", status:null, status_date:null },
  ...
  "k3": {
    ...
    items: [
      { id:"k3-09", name:"JALカード 年会費（三菱UFJニコス）", amount:1742, card:"PayPay 銀行から引落（三菱UFJニコス）", memo:"【2026-09-19 Mits様「JALカード　年会費と一つ決済」「こっちが年会費　20,900円で」】PayPay 銀行の引落 2026-06-10 20,900円が年会費。月割り＝20,900÷12＝1,742。もう1件の 3/10 2,200円は1回の決済としてサブスク外へ。", notion_url:null, url:null, cycle:"annual", annual_amount:"20,900円", annual_jpy:20900, last_paid:"2026-06-10", next_due:"2027-06-10予定", status:null, status_date:null },
      ...
      { id:"k3-10", name:"Amex US Delta 追加カード年会費（家族カード）", amount:2370, card:"Amex US 81007", memo:"【サブスク外の判定から移動・2026-09-20 Mits様「RENEWAL MEMBERSHIP FEE（追加カード年会費）はサブスク　年会費に」】2026-07-07 RENEWAL MEMBERSHIP FEE $175.00 ＠162.4782（MF換算）＝28,434円。月割り＝28,434÷12＝2,370。k3-08 の memo にあった「別行扱い」の行。", notion_url:null, cycle:"annual", annual_amount:"$175.00（28,434円）", annual_jpy:28434, last_paid:"2026-07-07", next_due:"2027-07予定", status:null, status_date:null }
    ]
  },
