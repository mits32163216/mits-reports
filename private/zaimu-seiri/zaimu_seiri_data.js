...
{ id:"k2-42", name:"Skool", amount:15751, card:"", memo:"【Mits様 2026-09-18 サブスク整理でdone】\n2026-09-18 完了。解約方法：コミュニティ設定 → Billing から解約（THE INNOVATION・今の請求期間の終わりでアーカイブ・参加/投稿/チャット不可・支払い受け取り停止・独自URL解放）。", notion_url:"https://app.notion.com/3c200782d90a8199ba0ccac9379e46d0", url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:"2026-08-18", next_due:"2026-09-18予定", status:"done", status_date:"2026-09-18" },
      ...
      { id:"k2-51", name:"BUSINESS I* BI_SUBSCRI", amount:1114, card:"", memo:"【サブスク外の判定から移動・2026-09-19】判定ページからサブスク側へ（Mits様 2026-09-19）", notion_url:null, url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:null, next_due:null, status:null, status_date:null },
      { id:"k2-52", name:"AQUA VOICE", amount:634, card:"", memo:"【サブスク外の判定から移動・2026-09-19】ネットのサービス（Mits様判定 2026-09-19：サブスク側）", notion_url:null, url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:null, next_due:null, status:null, status_date:null },
      { id:"k2-53", name:"AMAZON DIGIT*CH4I112", amount:254, card:"", memo:"【サブスク外の判定から移動・2026-09-19】ネットのサービス（Mits様判定 2026-09-19：サブスク側）", notion_url:null, url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:null, next_due:null, status:null, status_date:null },
      { id:"k2-54", name:"AMAZON DIGIT*BK29C1S", amount:254, card:"", memo:"【サブスク外の判定から移動・2026-09-19】ネットのサービス（Mits様判定 2026-09-19：サブスク側）", notion_url:null, url:null, cycle:"monthly", annual_amount:null, annual_jpy:null, last_paid:null, next_due:null, status:null, status_date:null },
