...
const LOAN_MONTHLY_LATEST  = 77598;   // 2026-09-19 ⑤ ペイディ 17,908 を追加（前 59690）   // 現在の月々の返済（① + ② + ③ + Amex US 利息 + 楽天その他）── 2026-09-19 ① の繰り上げ返済を取り消し
const LOAN_MONTHLY_BEFORE  = 139450;  // 9/18 完済前（① + ④-1 + ④-2 + ④-3 が生きていた頃）
const LOAN_MONTHLY_LABEL   = "④-1 ＋ ④-2 ＋ ④-3 完済後・① は取り消し・⑤ ペイディを追加";
    ...
    if (isBorrow) {
      ...
      divider.innerHTML = `
        <div class="pane pane-b" style="border-left-width:6px;">
          ...
          <div class="metrics">
            <div class="metric"><div class="label">月々の返済 <span style="color:#2e7d32;font-size:10px;font-weight:bold;">（${LOAN_MONTHLY_LABEL}）</span></div><div class="value">${fmtYen(LOAN_MONTHLY_LATEST)}<span class="yen">円</span><div class="sub-line">① 楽天キャッシングリボ 16,115 ／ ② Amex JP リボ 15,000 ／ ③ 楽天デンタル分割 17,288 ／ ⑤ ペイディ 17,908 ／ Amex US 利息 9,512 ／ その他 1,775<br><span style="color:#9aa1a8;font-size:10px;">前 131,738（− みたゆた×2 72,048）／ 前 ${fmtYen(LOAN_MONTHLY_BEFORE)}（− ④-1 8WEEKS.AI 7,712）</span></div></div></div>
            <div class="metric"><div class="label">残っている元金 合計（判明分）<span style="color:#2e7d32;font-size:10px;font-weight:bold;">（${LOAN_MONTHLY_LABEL}）</span></div><div class="value">1,656,738<span class="yen">円</span><div class="sub-line">楽天 822,200（① キャッシングリボ 390,000 ＋ ③ デンタル分割 432,200）＋ Amex JP 476,370（② リボのみ）＋ ⑤ ペイディ 358,168（8月末）（＋ Amex US 未確定）<br><span style="color:#9aa1a8;font-size:10px;">前 1,365,244（− みたゆた×2 66,674）／ 前 1,408,051（− 8WEEKS.AI 42,807）</span></div></div></div>
          </div>
